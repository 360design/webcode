...
<?php include get_template_directory().'/topline+breadcrumb.php'; ?>
    ...
    <div ng-controller="AtmfFrontEnd">
        <div class="container">
			<div class="row">
				...
				<!-- start of main  -->
				<div class="col-md-3 sidebar" rel="sidebar">
					<?php  get_search_sidebar(); ?>
				</div>
				<!-- end of sidebar  -->

				<!-- Start of main  -->
				<div class="col-md-7 main" rel="main">
					<?php  get_search_result(); ?>
				</div>
				<!-- end of main  -->

                <!-- Start of banner right sidebar  -->
				<div class="col-md-2 main" rel="sidebar">
